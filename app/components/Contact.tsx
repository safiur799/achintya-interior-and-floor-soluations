...
export default function Contact({ formStatus, handleFormSubmit }: ContactProps) {
    return (
        <section id="contact">
            ...
            <div className="contact-container">
                <div className="contact-info">
                    ...
                    <br />
                    <div className="card" style={{ borderRadius: "12px", height: "150px" }}>
                        <img src="/assets/hero.png" alt="Office Sample" style={{ height: "100%", width: "100%", objectFit: "cover" }} />
                    </div>
                </div>
