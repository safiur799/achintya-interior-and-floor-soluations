      ...
      <div className="relative z-10 text-center px-6 max-w-4xl">
        ...
        <div ref={logoRef} className="mb-12">
          ...
          <div
            ...
            style={{ backgroundColor: "var(--maintenance-accent)" }}
          />
        </div>
        ...
        <div ref={textRef} className="mb-16">
          <h1 className="text-5xl md:text-7xl font-extrabold mb-6 tracking-tight leading-tight">
            We&apos;re Under <br />
            <span className="maintenance-gradient-text">Refinement</span>
          </h1>
          <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto font-light leading-relaxed">
            We are currently enhancing our digital presence to better serve your
            vision. Our masterpiece is being polished and will be back shortly.
          </p>
        </div>
        ...
        <div ref={contactRef} className="space-y-8">
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12">
            <div className="group cursor-pointer">
              ...
              <a
                href="mailto:info@achintyainterior.com"
                className="text-lg hover:maintenance-accent-text transition-colors"
              >
